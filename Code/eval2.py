...
parser.add_argument("--model", default="checkpoint_4/model_epoch_49.pth", type=str, help="model path")
parser.add_argument("--dataset", default="hanbin_LR", type=str, help="dataset name, Default: hanbin_LR")
...
best_psnr_scale_two = 0.0
best_psnr_scale_three = 0.0
best_pnsr_scale_four = 0.0
            
for i in range(1,51):
    model_path = 'checkpoint_bn_1_1/model_epoch_bn_{i}.pth'
